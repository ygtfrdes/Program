...
/*----------------------------------------------------------------------------*/
uint8_t is_my_address(address_t *a) {
...
/*----------------------------------------------------------------------------*/
static void accepted_address_free(accepted_address_t *n) {
...
/*----------------------------------------------------------------------------*/
accepted_address_t *address_list_contains(address_t *a) {
...
/*----------------------------------------------------------------------------*/
void add_accepted_address(address_t *address) {
...
/*----------------------------------------------------------------------------*/
void fill_array_with_address(uint8_t *array, address_t *address) {
	uint16_t i;
...
/*----------------------------------------------------------------------------*/
address_t get_address_from_int(uint16_t value) {
	address_t address;
...
/*----------------------------------------------------------------------------*/
address_t get_address_from_array(uint8_t *array) {
	uint16_t i;
	address_t address;
	for (i = 0; i < ADDRESS_LENGTH; ++i) {
...
/*----------------------------------------------------------------------------*/
void set_broadcast_address(address_t *address) {
	uint16_t i;
	for (i = 0; i < ADDRESS_LENGTH; ++i) {
		address->u8[i] = 255;
	}
...
/*----------------------------------------------------------------------------*/
uint8_t is_broadcast(address_t *a) {
	uint16_t i;
	for (i = 0; i < ADDRESS_LENGTH; ++i) {
		if (a->u8[i] != 255) {
			return 0;
...
/*----------------------------------------------------------------------------*/
uint8_t address_cmp(address_t *a, address_t *b) {
	uint16_t i;
	for (i = 0; i < ADDRESS_LENGTH; ++i) {
		if (a->u8[i] != b->u8[i]) {
			return 0;
