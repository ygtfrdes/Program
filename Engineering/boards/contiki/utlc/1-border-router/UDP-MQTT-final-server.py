...
def start_client():
	...
	if ENABLE_MQTT:
		...
		client.username_pw_set("BBFF-e9fe9857d97cbfd5c156eb42c584d52ef15", "UTLC") #A1E-dEzBw6HHcOgRUz22KIwvuYkfvmfixy, A1E-rnSeKf6ZnttxdT4d2aXmpU45Eyrzst
	...
	# Start the MQTT thread and handle reconnections, also ensures the callbacks being triggered
	client.loop_start()
